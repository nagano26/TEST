...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/oauth-xx/oauth-ruby/issues", "changelog_uri" => "https://github.com/oauth-xx/oauth-ruby/blob/v0.6.1/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/oauth/0.6.1", "homepage_uri" => "https://github.com/oauth-xx/oauth-ruby", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/oauth-xx/oauth-ruby/tree/v0.6.1", "wiki_uri" => "https://github.com/oauth-xx/oauth-ruby/wiki" } if s.respond_to? :metadata=
